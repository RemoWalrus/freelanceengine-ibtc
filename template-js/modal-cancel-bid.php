    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php _e( "Application Retraction", ET_DOMAIN ) ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" id="form-cancel-bid" class="form-cancel-bid fre-modal-form">
                    <div class="fre-content-confirm">
                        <h2><?php _e( 'Are you sure you want to cancel your application on this project?', ET_DOMAIN ); ?></h2>
                        <p><?php _e( 'Once you cancel the application, this project will be removed from your working list. However, you can bid this project again after canceling.', ET_DOMAIN ); ?></p>
                    </div>
