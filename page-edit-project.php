...
$total_bids = $post_convert->total_bids;
?>
            ...
            <div id="fre-post-project-2 step-post" class="fre-post-project-step step-wrapper step-post active">
                <div class="fre-post-project-box">
                    ...
                    <?php
                        ...
                        <div>
                            <h2 style="font-size: 25px; "><?php _e('Your Cannot Edit This Project', ET_DOMAIN);?></h2>
                            <div class="fre-post-project-btn">
                                <a class="fre-btn fre-post-project-next-btn primary-bg-color" href="<?php echo et_get_page_link( "my-project" ); ?>"><?php _e("Back", ET_DOMAIN); ?></a>
                            </div>
                        </div>
                    <?php
                    } ?>
