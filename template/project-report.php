            ...
            <div class="row">
                <div class="col-lg-8 col-md-7">
                    ...
                    <ul class="project-disputed-info-list">
						<?php if ( current_user_can( 'manage_options' ) && ae_user_role( $user_ID ) != FREELANCER) { ?>
                            <li>
                ...
                <div class="col-lg-4 col-md-5">
					...
					<?php if ( current_user_can( 'manage_options' ) && ae_user_role( $user_ID ) != FREELANCER && $post->post_status != 'disputed' ) { ?>
