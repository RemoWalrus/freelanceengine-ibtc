		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">
					<?php _e("Application acceptance confirmation", ET_DOMAIN) ?>
				</h4>
			</div>
...
<script type="text/template" id="bid-info-template">
	<p>
		<?php _e( 'You are about to accept this application for' , ET_DOMAIN ); ?> <strong>{{=budget}}</strong>
		<?php _e( 'This application acceptance requires the payment below' , ET_DOMAIN ); ?>
	</p>
