                ...
                <div class="project-detail-action">
					...
					if ( is_user_logged_in() ) {
						if ( $project_status == 'publish' ) {
							...
							} else if ( ( ( fre_share_role() || $user_role == EMPLOYER ) || (current_user_can( 'manage_options' ) && $user_role != FREELANCER ) ) && $user_ID == $project->post_author ) {
							...
							if ( (int) $project->post_author == $user_ID || $bid_accepted_author == $user_ID || (current_user_can( 'manage_options' ) && $user_role != FREELANCER ) ) {
							...
							} else if (current_user_can( 'manage_options' ) && $user_role != FREELANCER && ae_get_option( 'use_escrow' ) ) {
							...
							} else if ( current_user_can( 'manage_options' ) && $user_role != FREELANCER ) {
