...
?>
    <div class="fre-page-wrapper list-profile-wrapper chairbk">
            ...
            <div class="container">
                <div class="author-<?php echo $class_name ?>-wrap">
                            ...
                            <div class="profile-<?php echo $class_name ?>-info">
								...
								if ( $author_available == 'on' || $author_available == '' ) {
									...
									echo '<div class="freelance-info-edit">';
										if( ( ae_user_role( $user_ID ) == EMPLOYER  || (current_user_can('manage_options') && ae_user_role( $user_ID ) != FREELANCER) ) && $user_ID != $author_id ) { ?>
					...
					<?php if ( fre_share_role() || ae_user_role( $author_id ) == FREELANCER ) {
						...
						if(is_user_logged_in() && (ae_user_role( get_current_user_id() ) == EMPLOYER || $author_id==get_current_user_id())){
							// list project worked
